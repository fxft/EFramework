 ...
 *******************for EFramework
 ...
 $(SRCROOT)/../../../comm/EFNew/EFWKLib/Frameworks/Public
 "$(SRCROOT)/../../../../projects/comm/external/umeng/share/UMSocial_Sdk_Extra_Frameworks/TencentOpenAPI"
...
- (void)load{
    ...
    [HMUIConfig sharedInstance].allowedPortrait = YES;
    [HMUIConfig sharedInstance].allowedLandscape = YES;
    ...
    [HMURLMap map:@"MainPage" bindto:@"*" URL:URLFOR_controllerWithNav(@"MainBoard")];
