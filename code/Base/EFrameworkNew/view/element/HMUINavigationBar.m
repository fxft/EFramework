...
- (UIActivityIndicatorView *)showTitleActivity:(BOOL)action{
    return [self showTitleActivity:action style:UIActivityIndicatorViewStyleWhite];
}

- (UIActivityIndicatorView *)showTitleGrayActivity:(BOOL)action{
    return [self showTitleActivity:action style:UIActivityIndicatorViewStyleGray];
}

- (UIActivityIndicatorView *)showTitleActivity:(BOOL)action style:(UIActivityIndicatorViewStyle)style{
    ...
    if (activity==nil) {
        activity = [[[UIActivityIndicatorView alloc]initWithActivityIndicatorStyle:style] autorelease];
