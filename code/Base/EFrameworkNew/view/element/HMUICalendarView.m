...
- (void)dealloc
{
    ...
    self.weekTitles = nil;
    self.dayTitleNormalFont = nil;
    self.weekenTitleColor = nil;
    self.weekTitleColor = nil;
    self.nonTitleNormalColor = nil;
    self.dayTitleHighlightFont = nil;
    self.todayTitleNormalColor = nil;
    self.leftArrow = nil;
    self.dayTitleHighlightFont = nil;
    self.weekTitleNormalFont = nil;
    self.dayTitleNormalColor = nil;
    self.dayBackSelectImage = nil;
    self.dayTitleSelectFont = nil;
    self.dayBackHighlightImage = nil;
    self.dayBackNormalImage = nil;
    self.dayTitleHighlightColor = nil;
    self.dayTitleSelectColor = nil;
    self.rightArrow = nil;
    HM_SUPER_DEALLOC();
}
