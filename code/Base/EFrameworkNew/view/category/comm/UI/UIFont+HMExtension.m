...
@implementation UIFont (HMExtension)
...
//    NSAssert([[NSFileManager defaultManager] fileExistsAtPath:[url path]], @"Font file doesn't exist");
    ...
    if (fontDataProvider==NULL){
        printf("******register a new Font file doesn't exist:%s******\n",url.absoluteString.UTF8String);
        return NO;
    }
    ...
    if (newFont==NULL){
        printf("******register a new Font DataProvider doesn't exist:%s******\n",url.absoluteString.UTF8String);
        return NO;
    }
    ...
    if (error!=NULL) {
        ...
        printf("******register a new font error:%ld******\n",CFErrorGetCode(error));
        return NO;
    }
    CFStringRef ref = CGFontCopyFullName(newFont);
    CFStringRef refPost = CGFontCopyPostScriptName(newFont);
    printf("******register a new font:%s**postScript:%s****\n",ref!=NULL?[(NSString*)ref UTF8String]:"error",refPost!=NULL?[(NSString*)refPost UTF8String]:"error");
    if (newFont)CGFontRelease(newFont);
    if (ref)CFRelease(ref);
    if (refPost)CFRelease(refPost);
...
+ (UIFont *)fontGoogleMaterialWithSize:(CGFloat)size
{
    ...
    dispatch_once(&onceToken, ^{
        [self registerIconFontWithURL:[[NSBundle mainBundle] URLForResource:@"GoogleMaterial" withExtension:@"ttf"]];
    });
#endif
...
+ (UIFont *)fontAwesomeWithSize:(CGFloat)size
{
    ...
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        [self registerIconFontWithURL:[[NSBundle mainBundle] URLForResource:@"FontAwesome" withExtension:@"ttf"]];
    });
#endif
