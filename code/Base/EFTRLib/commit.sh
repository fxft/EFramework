...
#iospath=${iphoneos}/${name}/${name}.framework/${name}
iospath=${file}/${name}
...
#mkdir -p "${SRCROOT}/../Frameworks/PublicOS"
#
#cp -r -f ${SRCROOT}/Frameworks/Public/*  ${SRCROOT}/../Frameworks/Public/
#cp -r -f ${SRCROOT}/Frameworks/PublicOS/*  ${SRCROOT}/../Frameworks/PublicOS/
